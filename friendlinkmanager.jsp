...
<html>
	...
	<div class="search-title">
		<h2>friend link manager</h2>
		<div class="description">
			<a
				href="<%=SystemParam.getSiteRoot() %>/admin/friendlinkmanager.do?actiontype=load&seedid=208">add friend link</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
	<div class="search-options">
		<form id="searchForm"
			action="<%=SystemParam.getSiteRoot() %>/admin/friendlinkmanager.do"
			method="post">
	...
	<div class="action-details">
		<a href="#" id="btnCheckAll" class="action-button"><img
			src="images/submit.gif">check</a> <a href="#" id="btnDelete"
			class="action-button"><img src="images/del.gif">delete</a>
	</div>
	<table id="module" width="100%" border="0" cellspacing="0"
		...
		<tbody>
			<c:if
				...
				<tr>
					<td colspan="20">has no records</td>
				</tr>
			</c:if>
			<c:forEach var="temfriendlink" items="${listfriendlink}">
				<tr>
					...
					<td><a class="orange-href"
						href="<%=SystemParam.getSiteRoot() %>/admin/friendlinkmanager.do?actiontype=load&id=${temfriendlink.id}&seedid=208">edit</a>
