...
<body>
	<div class="search-title">
		...
		<div class="description">modify account information</div>
	</div>
	<form name="usersform" method="post"
		...
		<table border="0" cellspacing="1" class="grid" cellpadding="0"
			width="100%">
			<tr>
				<td height="30" align="right">account name:</td>
				<td>${requestScope.users.username}
				<input name="username"
			...
			<tr>
				...
				<td><input name="email" value="${requestScope.users.email}"
					...
					validate="{required:true,messages:{required:'please input email'}}" /></td>
			</tr>
			
		
			<tr>
				<td height="30" align="right">nick name:</td>
			...
			<tr>
				<td height="30" align="right">sex :</td>
