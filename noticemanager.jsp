...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="<%=SystemParam.getSiteRoot() %>/admin/noticemanager.do?actiontype=load&seedid=207">publish notice</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
	<div class="search-options">
		<form id="searchForm"
			action="<%=SystemParam.getSiteRoot() %>/admin/noticemanager.do"
			method="post">
			...
			<c:forEach var="temnotice" items="${listnotice}">
				<tr>
					...
					<td><a class="orange-href"
						href="<%=SystemParam.getSiteRoot() %>/admin/noticemanager.do?actiontype=load&id=${temnotice.id}&seedid=207">eidt</a>
						<a class="orange-href"
						href="<%=SystemParam.getSiteRoot() %>/e/noticeinfo.jsp?id=${temnotice.id}"  target="_blank">view</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
