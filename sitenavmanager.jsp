...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="<%=SystemParam.getSiteRoot() %>/admin/sitenavmanager.do?actiontype=load">+add site nav</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
	<div class="search-options">
		<form id="searchForm"
			...
			<table cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td>nav name: <input name="title" value="${title}"
							...
							<div class="ui-button">
								<button class="ui-button-text">search</button>
							</div>
						</td>
					</tr>
				</tbody>
	...
	<div class="action-details">
		<a href="javascript:void(0)" class="btn btn-success" id="btnCheckAll"
			class="action-button">check</a> <a id="btnDelete" class="action-btn"
			href="javascript:void(0)"> <em class="icon-delete"></em> <b>delete</b>
		</a>
	</div>
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="orange-href"
					href="<%=SystemParam.getSiteRoot() %>/admin/sitenavmanager.do?actiontype=load&id=<%=temsitenav.getId()%>&forwardurl=/admin/sitenavadd.jsp">edit</a>
