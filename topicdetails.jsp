...
<%
   ...
   Topic temobjtopic=null;
    if( id!=null)
    {
      temobjtopic=(Topic)DALBase.load("topic"," where id="+ id);
...
<body >
	...
	<table cellpadding="0" cellspacing="1" class="grid" width="100%">
		...
		<tr>
			...
			<td>${requestScope.topic.pubtime}</td>
		</tr>
		...
		<tr>
			...
			<td>${requestScope.topic.istopic}</td>
		</tr>
		<tr>
			<td width="10%" align="right">最后回帖人:</td>
			<td>${requestScope.topic.lastreplyor}</td>
		</tr>
		<tr>
			<td width="10%" align="right">最后回帖时间:</td>
			<td>${requestScope.topic.lastreplytime}</td>
		</tr>
		<tr>
			<td width="10%" align="right">回帖次数:</td>
			<td>${requestScope.topic.replycount}</td>
		</tr>
		<tr>
			<td width="10%" align="right">主题编号:</td>
			<td>${requestScope.topic.replyid}</td>
		</tr>
		<tr>
