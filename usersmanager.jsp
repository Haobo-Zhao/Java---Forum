...
<html>
	 ...
	 <body >
		<div class="search-title">
			...
			<div class="description">
				<a  href="<%=SystemParam.getSiteRoot() %>/admin/usersmanager.do?actiontype=load">+Add user</a>
			</div>
		</div>
					<!-- 搜索控件开始 -->
	...
	<div class="action-details">
		<a href="#" class="btn btn-success" id="btnCheckAll"
			...
			href="#"> <em class="icon-delete"></em> <b>delete</b> </a>
	</div>
				...
				<td>
				   <a class="orange-href"
					href="<%=SystemParam.getSiteRoot() %>/admin/usersdetails.jsp?id=<%=temusers.getId()%>"><i
						class="icon-zoom-in icon-white"></i>view</a></td>
			</tr>
			<%}}%>
		</tbody>
	</table>
